...
import com.example.introact.ml.Model2;
...
public class VegetableFruitImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vegetable_fruit_image);
    ...
    public void classifyImage(Bitmap image){
        try {
            ...
            String[] classes = {"Fresh_Cauliflower","Fresh_Eggplant","Fresh_Peas","Fresh_Potato","Fresh_Tomato"};
//            String[] classes = {"Fresh_Cauliflower","Fresh_Eggplant","Fresh_Peas","Fresh_Potato","Fresh_Tomato","Rotten_Tomato"};
